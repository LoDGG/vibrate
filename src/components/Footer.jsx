  ...
  return (
    <footer className="bg-[#0A0A0A] text-white py-12 border-t border-zinc-800">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 text-sm">
        ...
        <div>
          <img src={logo} alt="Celebrise Logo" className="h-10 mb-4" />
        ...
        <div>
          ...
          <ul className="space-y-2 text-zinc-400">
            ...
            <li><a href="#contact" className="hover:text-pink-400 transition">Devis</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-zinc-400">
            <li>📧 contact@celebrise.event</li>
            <li>📞 06 00 00 00 00</li>
            <li>📍 Basé à Melun (77)</li>
            <li>📸 Instagram : @celebrise.events</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-zinc-400">
            ...
            <li className="mt-4 text-xs">© 2025 Celebrise — Tous droits réservés</li>
          </ul>
        </div>
      </div>
